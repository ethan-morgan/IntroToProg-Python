...
while (True):
    ...
    if (strChoice.strip() == '1'):
        try:
            print("Task -- Priority") # Print Title for Clarity
            print("=" * 30)
            for row in lstTable:
                print(row["Task"] + " -- " + row["Priority"]) # Print out Row Task and Priority from File
        except:
    ...
    # Step 4 - Add a new item to the list/Table
        ...
        # User Defined Inputs for Task and Priority
        # '.strip()' used to remove any extra characters
        # 'if' Statement used to require necessary input for Priority
